...
export const INITIAL_WORDS: WordData[] = [
  {
    ...
    phonetic: "/ˈæp.əl/",
    translation: "A round fruit with red or green skin.",
  ...
  },
  {
    ...
    root: "hap (luck) + y",
    phonetic: "/ˈhæp.i/",
    translation: "Feeling or showing pleasure or contentment.",
    chineseTranslation: "快乐的",
  ...
  },
  {
    ...
    root: "Greek 'tigris'",
    phonetic: "/ˈtaɪ.ɡɚ/",
    translation: "A large cat with orange and black stripes.",
    chineseTranslation: "老虎",
